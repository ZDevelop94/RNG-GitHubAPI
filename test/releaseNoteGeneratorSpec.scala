...
class releaseNoteGeneratorSpec extends PlaySpec with ShouldMatchers{
  ...
  "releaseNoteGenerator" should {
    "extract a list of commits" in {
      RNG.messageExtractor(validGitHubResponseJson).contains("adding extra tests") shouldBe true
    }
